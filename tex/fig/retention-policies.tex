...
%-------------------------------------------------------------------------------
  ...
  \centering
    \bf{Record Gap Size}\\
    $\mathcal{O}(\log(\colorT))$\\
    \bf{Retained Records}\\
    $\mathcal{O}(\colorT - \colorTbar)$
  }
  \makecell[{{p{0.14\textwidth}}}]{
  }\\\hline
%-------------------------------------------------------------------------------
  ...
  \centering
    ...
    $\mathcal{O}(1)$\\
    \bf{Retained Records}\\
    $\mathcal{O}(\colorT^{1/a} \times (\colorT - \colorTbar))$
  }
  \makecell[{{p{0.14\textwidth}}}]{
  \raggedright
  }\\\hline
%-------------------------------------------------------------------------------
  ...
  \end{tabular}
  \caption{
  \textbf{Comparison of stream curation policy algorithms.}
  \footnotesize
  ...
  Policy visualizations are provided for two contrasting parameterizations for each policy algorithm.
  }
