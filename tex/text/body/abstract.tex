...
% This ability to bias towards recent time points was driven by our original area of application (phylogenetic reconstruction), but we expect it to be useful in other contexts as well.
