...
Because ongoing data feeds necessitate continual downsampling when faced with storage and memory limitations, the streaming curation problem occurs also in context of data streams, and relates closely to the concept of binning in this context.
...
Here, we formalize the theoretical foundations of hereditary stratigraphy through exposition of streaming curation algorithms and describe a procedure to perform ancestry tree reconstruction from a population of hereditary stratigraph annotations.
