...
Hereditary stratigraphy's tractability hinges on suitable representation of binned stream records.
...
We propose a suite of indexing schemes that reduce representational overhead for fingerprint records to a single generation-count value.
