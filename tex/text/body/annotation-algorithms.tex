\section{Stream Curation Algorithms} \label{sec:annotation-algorithms}
...
Recency-proportional techniques are potentially useful in a variety of contexts where recent information is more valuable or varied.
