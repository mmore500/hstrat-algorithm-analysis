...
\input{alg/fr/fr-enum-retained-ranks.tex}
\input{alg/fr/fr-gen-drop-ranks.tex}
\input{thm/fr/fr-self-consistency.tex}
% \input{thm/fr/fr-space-complexity.tex}
% \input{thm/fr/fr-uncertainty-bound.tex}

\subsection{Depth-Proportional Resolution (DPR) Policy Algorithm}

\input{alg/dpr/dpr-enum-retained-ranks.tex}
\input{alg/dpr/dpr-gen-drop-ranks.tex}
\input{thm/dpr/dpr-self-consistency.tex}
% \input{thm/dpr/dpr-space-complexity.tex}
% \input{thm/dpr/dpr-uncertainty-bound.tex}

\subsection{Recency-proportional Resolution (RPR) Policy Algorithm}

\input{alg/rpr/rpr-enum-retained-ranks.tex}
\input{alg/rpr/rpr-gen-drop-ranks.tex}
\input{thm/rpr/rpr-self-consistency.tex}
\input{thm/rpr/rpr-space-complexity.tex}
% \input{thm/rpr/rpr-uncertainty-bound.tex}
...
% \input{thm/gsnr/gsnr-space-complexity.tex}
% \input{thm/gsnr/gsnr-uncertainty-bound.tex}

\subsection{Curbed Recency-proportional Resolution (CRPR) Policy Algorithm}

\input{alg/crpr/crpr-enum-retained-ranks.tex}
\input{alg/crpr/crpr-gen-drop-ranks.tex}
\input{thm/crpr/crpr-self-consistency.tex}
% \input{thm/crpr/crpr-space-complexity.tex}
% \input{thm/gsnr/gsnr-uncertainty-bound.tex}
