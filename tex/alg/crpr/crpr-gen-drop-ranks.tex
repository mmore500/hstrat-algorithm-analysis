% https://github.com/mmore500/hstrat/blob/master/hstrat/stratum_retention_strategy/stratum_retention_algorithms/recency_proportional_resolution_curbed_algo/_enact/_GenDropRanks_/_GenDropRanks.py
\begin{algorithm}
